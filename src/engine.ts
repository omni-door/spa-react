import vm from 'vm';
import { STRATEGY, PROJECT_TYPE, STYLE } from '@omni-door/utils';
...
// export function generate_tpl<T extends keyof typeof tpls>(
//   tpls: { [tplName: string]: string },
//   tplName: T,
//   params?: { [param: string]: string }
// ) {
...
// console.info(generate_tpl(tpls, 'tplA'))